USE [DADOSPRO]
GO
/****** Object:  StoredProcedure [dbo].[SP_REL_MOVIMENTO_DIARIO_PROART_FILIAIS]    Script Date: 10/08/2021 17:41:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
/******************************************************************************
* PROCEDURE : SP_REL_MOVIMENTO_DIARIO_PROART_FILIAIS						  *
...
EXEC SP_REL_MOVIMENTO_DIARIO_PROART_FILIAIS '20150501','20150531','','ZZZZZZZZZZZZZZZ','  ', '  ', '02', '3'
*/
ALTER PROCEDURE [dbo].[SP_REL_MOVIMENTO_DIARIO_PROART_FILIAIS]
	@DINICIO VARCHAR(10),
	@DFINAL VARCHAR(10),
...
BEGIN
	DECLARE @CLOCALFIN VARCHAR(2),
			@CTIPOFIN VARCHAR(2),
			@CNOMFILIAL VARCHAR(20)

	SET @CLOCALFIN = 'ZZ'
	SET @CTIPOFIN = 'ZZ'
	SET @CNOMFILIAL='TAIFFPROART - ???'
	IF @CFILIAL='02'
	BEGIN
		SET @CNOMFILIAL='TAIFFPROART EXTREMA'
	END
	IF @CFILIAL='03'
	BEGIN
		SET @CNOMFILIAL='TAIFFPROART BARUERI'
	END
	...
	--
    CREATE TABLE #TEMP_SALDO_INICIAL_PROART_FILIAL_DE_SB6
      (
	...
	INSERT INTO #TEMP_SALDO_INICIAL_PROART_FILIAL_DE_SB6
      (
		B6_PRODUTO	,
		B1_DESC		,
		B1_TIPO		,
		...
		FROM SB6030 SB6 WITH(NOLOCK)
			INNER JOIN SB1030 SB1 WITH(NOLOCK) ON SB1.B1_COD=SB6.B6_PRODUTO AND SB1.B1_FILIAL = SB6.B6_FILIAL AND SB1.D_E_L_E_T_ <> '*' 
		WHERE   
			SB6.D_E_L_E_T_ 	 	<> '*' 
	...
	FROM #TEMP_SALDO_INICIAL_PROART_FILIAL_DE_SB6 AUX
	...
	--
    CREATE TABLE #TEMP_MOVIMENTOS_DE_SB6_PROART_FILIAL
      (
		B6_PRODUTO	VARCHAR(15)		 NULL,
		B1_DESC		VARCHAR(50)		 NULL,
		B1_TIPO		VARCHAR(2)		 NULL,
	...
	INSERT INTO #TEMP_MOVIMENTOS_DE_SB6_PROART_FILIAL
      (
		B6_PRODUTO	,
		B1_DESC		,
		B1_TIPO		,
		...
		FROM SB6030 SB6 WITH(NOLOCK)
			INNER JOIN SB1030 SB1 WITH(NOLOCK) ON SB1.B1_COD=SB6.B6_PRODUTO AND SB1.B1_FILIAL = SB6.B6_FILIAL AND SB1.D_E_L_E_T_ <> '*' 
			INNER JOIN SF4030 SF4 WITH(NOLOCK) ON F4_CODIGO = B6_TES AND SF4.D_E_L_E_T_	= ' ' AND SF4.F4_FILIAL  = SB6.B6_FILIAL 
			LEFT OUTER JOIN ZAJ010 ZAJ WITH(NOLOCK) ON ZAJ_COD = F4_META AND ZAJ.D_E_L_E_T_	= ' '
		WHERE   
			SB6.D_E_L_E_T_ 	 	<> '*' 
			AND SB6.B6_FILIAL	= @CFILIAL
			AND SB1.B1_TIPO		>= @CTIPOINI
	...
	INSERT INTO #TEMP_MOVIMENTOS_DE_SB6_PROART_FILIAL
      (
		...
		WHERE   
			...
			AND SB6.B6_PODER3	=  'D'
			AND EXISTS (
						SELECT 'X' FROM SB6030 AUX WITH(NOLOCK)
						WHERE  
	...
	FROM #TEMP_MOVIMENTOS_DE_SB6_PROART_FILIAL AUX
	WHERE AUX.B6_LOCAL=' '
	...
	UPDATE AUX
		SET SLD_INICIAL = ISNULL( 
			(
				SELECT SUM(B6_QUANT) FROM #TEMP_SALDO_INICIAL_PROART_FILIAL_DE_SB6 AUX_II 
				WHERE 
	...
	INSERT INTO #TEMP_MOVIMENTOS_DE_SB6_PROART_FILIAL
      (
		...
		B1_ITEMCC
			...
			B1_ITEMCC
		FROM #TEMP_SALDO_INICIAL_PROART_FILIAL_DE_SB6 TMP
		WHERE NOT EXISTS (
						SELECT 'X' FROM #TEMP_MOVIMENTOS_DE_SB6_PROART_FILIAL AUX 
						WHERE
	...
	-- COMENTADO POR GILBERTO E CRIADA OUTRA LINHA PARA OBTER O CUSTO DE ACORDO COM O FECHAMENTO DO PRÓPRIO PROTHEUS - 29/10/2014
	--UPDATE #TEMP_MOVIMENTOS_DE_SB6_PROART_FILIAL SET VL_CUSTO = ISNULL((SELECT DISTINCT CONVERT( DECIMAL(12,4) , ZAI_CUSTO ) FROM ZAI010 WHERE ZAI_FILIAL='' AND B6_PRODUTO=ZAI_CODPRO  AND D_E_L_E_T_=' '),0)
	UPDATE #TEMP_MOVIMENTOS_DE_SB6_PROART_FILIAL SET VL_CUSTO = CAST((SELECT dbo.RET_CUSTO_ATUAL_CT('03', @CFILIAL, '21', CONVERT(VARCHAR(8), GETDATE(), 112), B6_PRODUTO)) AS DECIMAL(12,4))
	...
	--
    CREATE TABLE #TEMP_SALDO_INICIAL_PROART_FILIAL
      (
	...
	IF @NTIPOREL = '1'
	BEGIN
		INSERT INTO #TEMP_SALDO_INICIAL_PROART_FILIAL
		  (
			B9_COD		,
			B1_DESC		,
			B1_TIPO		,
			...
			VL_CUSTO	,
			B1_ITEMCC
		  ) EXEC [SP_REL_MOVIMENTO_DIARIO_SALDO_SB9_PROART_FILIAIS] @DINICIO, @DFINAL, @CPRODUTOINI, @CPRODUTOFIN,	@CLOCALINI, @CTIPOINI, @CFILIAL
	END
	...
	BEGIN
		INSERT INTO #TEMP_SALDO_INICIAL_PROART_FILIAL
		  (
			...
			VL_CUSTO	,
			B1_ITEMCC
		  ) EXEC [SP_REL_MOVIMENTO_DIARIO_SALDO_SB2_PROART_FILIAIS] @DINICIO, @DFINAL, @CPRODUTOINI, @CPRODUTOFIN,	@CLOCALINI, @CTIPOINI, @CFILIAL
	END

	--
	-- Cria tabela que recebe movimentos de Entrada de NF
	--
    CREATE TABLE #TEMP_MOVIMENTOS_DE_SD1_PROART_FILIAL
      (
	...
	INSERT INTO #TEMP_MOVIMENTOS_DE_SD1_PROART_FILIAL
      (
		D1_COD		,
		B1_DESC		,
		B1_TIPO		,
		...
		B1_ITEMCC	
			...
			B1_ITEMCC	
		FROM SD1030 SD1 WITH(NOLOCK)
			INNER JOIN SB1030 SB1 WITH(NOLOCK) ON SB1.B1_COD=SD1.D1_COD AND SB1.B1_FILIAL = SD1.D1_FILIAL AND SB1.D_E_L_E_T_ <> '*'
			INNER JOIN SF4030 SF4 WITH(NOLOCK) ON F4_CODIGO = D1_TES AND SF4.F4_ESTOQUE='S' AND SF4.D_E_L_E_T_	= ' ' AND SF4.F4_FILIAL = SD1.D1_FILIAL
			LEFT OUTER JOIN ZAJ010 ZAJ WITH(NOLOCK) ON ZAJ_COD = F4_META AND ZAJ.D_E_L_E_T_	= ' '
		WHERE   
			SD1.D_E_L_E_T_ 	 	<> '*' 
	...
	--
    CREATE TABLE #TEMP_MOVIMENTOS_DE_SD2_PROART_FILIAL
      (
	...
	INSERT INTO #TEMP_MOVIMENTOS_DE_SD2_PROART_FILIAL
      (
		D2_COD		,
		B1_DESC		,
		B1_TIPO		,
		...
		B1_ITEMCC
			...
			B1_ITEMCC
		FROM SD2030 SD2 WITH(NOLOCK)
			INNER JOIN SB1030 SB1 WITH(NOLOCK) ON SB1.B1_COD=SD2.D2_COD AND SB1.B1_FILIAL = SD2.D2_FILIAL AND SB1.D_E_L_E_T_ <> '*' 
			INNER JOIN SF4030 SF4 WITH(NOLOCK) ON F4_CODIGO = D2_TES AND SF4.F4_ESTOQUE='S' AND SF4.D_E_L_E_T_	= ' ' AND SF4.F4_FILIAL = SD2.D2_FILIAL
			LEFT OUTER JOIN ZAJ010 ZAJ WITH(NOLOCK) ON ZAJ_COD = F4_META AND ZAJ.D_E_L_E_T_	= ' '
		WHERE   
			SD2.D_E_L_E_T_ 	 	<> '*' 
	...
	--
    CREATE TABLE #TEMP_MOVIMENTOS_DE_SD3_PROART_FILIAL
      (
	...
	INSERT INTO #TEMP_MOVIMENTOS_DE_SD3_PROART_FILIAL
      (
		D3_COD		,
		B1_DESC		,
		B1_TIPO		,
		...
		FROM SD3030 SD3 WITH(NOLOCK)
			INNER JOIN SB1030 SB1 WITH(NOLOCK) ON SB1.B1_COD=SD3.D3_COD AND SB1.B1_FILIAL = SD3.D3_FILIAL AND SB1.D_E_L_E_T_ <> '*' 
		WHERE   
			SD3.D_E_L_E_T_ 	 	<> '*' 
	...
	-- COMENTADO POR GILBERTO E CRIADA OUTRA LINHA PARA OBTER O CUSTO DE ACORDO COM O FECHAMENTO DO PRÓPRIO PROTHEUS - 29/10/2014
	--UPDATE #TEMP_MOVIMENTOS_DE_SD1_PROART_FILIAL SET VL_CUSTO = ISNULL((SELECT DISTINCT CONVERT( DECIMAL(12,4) , ZAI_CUSTO ) FROM ZAI010 WHERE ZAI_FILIAL='' AND D1_COD=ZAI_CODPRO  AND D_E_L_E_T_=' '),0)
	UPDATE #TEMP_MOVIMENTOS_DE_SD1_PROART_FILIAL SET VL_CUSTO = CAST((SELECT dbo.RET_CUSTO_ATUAL_CT('03', @CFILIAL, '21', CONVERT(VARCHAR(8), GETDATE(), 112), D1_COD)) AS DECIMAL(12,4))
	
	--UPDATE #TEMP_MOVIMENTOS_DE_SD2_PROART_FILIAL SET VL_CUSTO = ISNULL((SELECT DISTINCT CONVERT( DECIMAL(12,4) , ZAI_CUSTO ) FROM ZAI010 WHERE ZAI_FILIAL='' AND D2_COD=ZAI_CODPRO  AND D_E_L_E_T_=' '),0)
	UPDATE #TEMP_MOVIMENTOS_DE_SD2_PROART_FILIAL SET VL_CUSTO = CAST((SELECT dbo.RET_CUSTO_ATUAL_CT('03', @CFILIAL, '21', CONVERT(VARCHAR(8), GETDATE(), 112), D2_COD)) AS DECIMAL(12,4))
	
	--UPDATE #TEMP_MOVIMENTOS_DE_SD3_PROART_FILIAL SET VL_CUSTO = ISNULL((SELECT DISTINCT CONVERT( DECIMAL(12,4) , ZAI_CUSTO ) FROM ZAI010 WHERE ZAI_FILIAL='' AND D3_COD=ZAI_CODPRO  AND D_E_L_E_T_=' '),0)
	UPDATE #TEMP_MOVIMENTOS_DE_SD3_PROART_FILIAL SET VL_CUSTO = CAST((SELECT dbo.RET_CUSTO_ATUAL_CT('03', @CFILIAL, '21', CONVERT(VARCHAR(8), GETDATE(), 112), D3_COD)) AS DECIMAL(12,4))
	

	DELETE #TEMP_SALDO_INICIAL_PROART_FILIAL	   
		WHERE ISNULL(B9_QINI,0) + ISNULL(D1_QUANT,0) + ISNULL(D2_QUANT,0) + ISNULL(D3_QUANT,0) = 0
		AND NOT EXISTS (SELECT 'X' FROM #TEMP_MOVIMENTOS_DE_SD1_PROART_FILIAL XSD1 WHERE B9_COD=D1_COD AND B9_LOCAL=D1_LOCAL)
		AND NOT EXISTS (SELECT 'X' FROM #TEMP_MOVIMENTOS_DE_SD2_PROART_FILIAL XSD2 WHERE B9_COD=D2_COD AND B9_LOCAL=D2_LOCAL)
		AND NOT EXISTS (SELECT 'X' FROM #TEMP_MOVIMENTOS_DE_SD3_PROART_FILIAL XSD3 WHERE B9_COD=D3_COD AND B9_LOCAL=D3_LOCAL)

	-- COMENTADO POR GILBERTO E CRIADA OUTRA LINHA PARA OBTER O CUSTO DE ACORDO COM O FECHAMENTO DO PRÓPRIO PROTHEUS - 29/10/2014
	--UPDATE #TEMP_SALDO_INICIAL_PROART_FILIAL	   SET VL_CUSTO = ISNULL((SELECT DISTINCT CONVERT( DECIMAL(12,4) , ZAI_CUSTO ) FROM ZAI010 WHERE ZAI_FILIAL='' AND B9_COD=ZAI_CODPRO  AND D_E_L_E_T_=' '),0)
	UPDATE #TEMP_SALDO_INICIAL_PROART_FILIAL	   SET VL_CUSTO = CAST((SELECT dbo.RET_CUSTO_ATUAL_CT('03', @CFILIAL, '21', CONVERT(VARCHAR(8), GETDATE(), 112), B9_COD)) AS DECIMAL(12,4))

	--
	-- Cria tabela que recebe movimentos entre armazens e produção
	--
    CREATE TABLE TEMP_ANALITICO_BM_PROART_FILIAL
      (
	...
	INSERT INTO TEMP_ANALITICO_BM_PROART_FILIAL
      (
		ID_LOCAL	,
		NM_ARMAZ	,
		B1_TIPO		,
		...
		FROM (
				SELECT
					...
					END AS VL_CUSTO				,
					B1_ITEMCC
				FROM #TEMP_MOVIMENTOS_DE_SD1_PROART_FILIAL
			UNION ALL
				SELECT
					...
					END AS VL_CUSTO				,
					B1_ITEMCC
				FROM #TEMP_MOVIMENTOS_DE_SD2_PROART_FILIAL
			UNION ALL
				SELECT
					...
					B1_ITEMCC
				FROM #TEMP_MOVIMENTOS_DE_SD3_PROART_FILIAL
			UNION ALL
				SELECT
					...
					B1_ITEMCC
				FROM #TEMP_SALDO_INICIAL_PROART_FILIAL	   
			UNION ALL
				SELECT 
					...
					B1_ITEMCC
				FROM #TEMP_MOVIMENTOS_DE_SB6_PROART_FILIAL 
				WHERE B6_TIPO='E'
			UNION ALL
				SELECT DISTINCT
					B6_LOCAL	AS ID_LOCAL		,
	...
	DELETE TEMP_ANALITICO_BM_PROART_FILIAL WHERE TT_QUANT=0


	--
	-- Cria tabela que recebe movimentos entre armazens e produção para Balanço de Massas - DTS
	--
    CREATE TABLE TEMP_MOVIMENTOS_BM_PROART_FILIAIS
      (
		ID_LOCAL	VARCHAR(2)		 NULL,
		NM_ARMAZ	VARCHAR(50)		 NULL,
		B1_TIPO		VARCHAR(2)		 NULL,
	...
	INSERT INTO TEMP_MOVIMENTOS_BM_PROART_FILIAIS
      (
		ID_LOCAL	,
		NM_ARMAZ	,
		B1_TIPO		,
	...
	DELETE TEMP_MOVIMENTOS_BM_PROART_FILIAIS WHERE TT_QUANT=0
